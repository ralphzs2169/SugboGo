...
function ActionCard({ title, description, Icon, iconColor, iconBg }) {
  return (
    <div className="group relative flex items-center justify-between rounded-2xl border border-stroke bg-background-primary p-6 shadow-sm transition-all hover:shadow-md cursor-pointer">
