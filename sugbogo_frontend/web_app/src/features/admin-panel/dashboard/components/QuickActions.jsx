...
/**
 * QuickActions component that renders a vertical stack of action cards for admin tasks.
 * Each card represents a specific action with an icon, title, and description.
 * A floating action button is positioned at the bottom right for additional actions.
 */
