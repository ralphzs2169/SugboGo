    ...
    <KeyboardAvoidingView className="flex-1" behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
      ...
      >
        ...
        <View style={styles.card} className="w-full rounded-[16px] bg-white p-6">
          <Text className="mb-6 text-[20px] font-bold text-[#1A1A1A] text-center ">Login to your account</Text>
          ...
          <View className="mb-4">
            <View className="mb-1.5 flex-row items-center justify-between">
              ...
              <TouchableOpacity>
                <Text className="text-[11px] font-bold tracking-[0.5px] text-[#F27F0D]">FORGOT?</Text>
              </TouchableOpacity>
            </View>
          ...
          <View className="mb-5 flex-row items-center">
            ...
            <Text className="mx-3 text-[11px] font-semibold tracking-[0.5px] text-[#999]">OR LOG IN WITH</Text>
            <View style={styles.dividerLine} />
          </View>
        ...
        <View className="mt-6 flex-row items-center">
          ...
          <TouchableOpacity onPress={() => router.push('/(auth)/register')}>
            <Text className="text-[14px] font-bold text-[#F27F0D]">Create an account</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </KeyboardAvoidingView>
