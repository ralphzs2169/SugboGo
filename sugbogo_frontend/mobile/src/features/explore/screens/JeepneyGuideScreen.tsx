...
/**
 * Shows backend-ranked direct jeepney guidance to one business.
 *
 * Location acquisition begins only after the Explorer opens this screen, and
        ...
        <View className="mb-4 flex-row items-center">
          ...
          <View className="ml-3 flex-1">
            <AppText weight="bold" className="text-lg text-text-primary">
              Direct Jeepney Guide
            </AppText>
            <AppText className="text-sm text-text-secondary">
              Routes from your current location
            </AppText>
          </View>
        </View>
