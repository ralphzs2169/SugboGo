...
/** Provides draft-only taxonomy controls for Explore results. */
export default function ExploreFiltersSheet({
  ...
  const visibleCategories = draft.clusterId === null
    ? options.categories
      ...
      <BottomSheetScrollView contentContainerClassName="px-5 pb-10">
            ...
            {visibleCategories.map((category) => {
              ...
              return (
                <Pressable
                  ...
                  className="min-h-12 flex-row items-center py-2 active:opacity-70"
                >
                  <MaterialCommunityIcons
                    name={
                      isSelected
        ...
        <View className="pt-5">
          ...
          <Pressable
            ...
            accessibilityRole="button"
            accessibilityState={{ selected: draft.specialtyTagId === null }}
            className="min-h-11 justify-center self-start py-2 active:opacity-70"
          >
            <AppText
              weight="semibold"
              className={
        ...
        {/* Draft actions */}
        <View className="mt-5 flex-row gap-3 border-t border-border-primary pt-5">
          <Pressable
            onPress={() =>
              onChange({
                ...draft,
            ...
            accessibilityRole="button"
            className="min-h-12 flex-1 items-center justify-center rounded-full border border-border-primary active:opacity-70"
          >
          ...
          <Pressable
            onPress={onApply}
            accessibilityRole="button"
            className="min-h-12 flex-[2] items-center justify-center rounded-full bg-brand active:opacity-80"
          >
