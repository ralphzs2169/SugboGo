...
from .views.application_views import (
    MerchantApplicationStatusView,
    MerchantApplicationView,
    MerchantModeAcknowledgeView,
)
...
urlpatterns = [
    ...
    path("", MerchantApplicationView.as_view(), name="application-detail"),
    path("submit/", MerchantApplicationView.as_view(), name="application-submit"),

    # Merchant Application Sections
    ...
    path("status/", MerchantApplicationStatusView.as_view(), name="application-status"),
    path("acknowledge-merchant-mode/", MerchantModeAcknowledgeView.as_view(), name="acknowledge-merchant-mode"),
]
