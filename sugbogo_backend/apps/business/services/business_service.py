...
from apps.business.models import Msme
...
class BusinessService:
    ...
    def list_businesses(search=None, ordering=None, category_id=None, cluster_id=None):
        """
        Retrieve ACTIVE businesses only (UC-02 Browse MSMEs stub) with optional
    ...
    @staticmethod
    def get_business(msme_id: int):
        """
        Retrieve a specific business by ID (UC-02 View MSME Profile stub).
    ...
    @staticmethod
    @transaction.atomic
    def verify_business(msme, action: str, reason: str = ""):
        """
