...
from apps.reviews.views.reply_template_views import (
    ReplyTemplateDetailView,
    ReplyTemplateView,
)
...
urlpatterns = [
    ...
    path("reply-templates/",ReplyTemplateView.as_view(),name="reply-template-list"),
    path("reply-templates/<int:template_id>/",ReplyTemplateDetailView.as_view(),name="reply-template-detail"),
]